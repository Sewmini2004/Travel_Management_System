...
public class GuideAPI {
    ...
    public ResponseEntity save(@ModelAttribute GuideDTO guideDTO){
        ResponseEntity<GuideDTO> guideDTOResponseEntity = restTemplate.postForEntity("http://guide-service/api/guideService",
                guideDTO,GuideDTO.class);
